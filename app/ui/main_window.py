...
class MainWindow(QMainWindow):
    ...
    def _init_replay_panel(self) -> None:
        ...
        fm = self._btn_replay_play_m.fontMetrics()
        play_w = fm.horizontalAdvance("Воспроизвести")
        pause_w = fm.horizontalAdvance("Пауза")
        self._btn_replay_play_m.setMinimumWidth(max(play_w, pause_w) + 20)
